...
from cpmtrang import CPMTrang

__CHANNEL_USERNAME__ = "CPMTrang"
__GROUP_USERNAME__   = "CPMTrangchat"
...
def banner(console):
    ...
    brand_name =  "Car Parking Multiplayer 1 Tool - @trangcute2102"
    colors = [
